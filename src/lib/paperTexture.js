...
export function applyColorScheme(mode = 'light') {
  ...
  if (mode === 'dark') {
    ...
    root.style.setProperty('--text-secondary', '#A89F94')
    root.style.setProperty('--text-muted', '#6B635A')
    ...
    root.style.setProperty('--text-secondary', '#6B635A')
    root.style.setProperty('--text-muted', '#9C948A')
